...
var settingsSetup = function() {
    ...
    GM_addStyle('root:{--chrome-background: #fff; --primary-background: #2a2f33; --secondary-background: #262a2e; --background-1: #191f22; --background-2: #fff; --background-3: #ccc; --background-4: #434343; --background-5: #fafafa; --background-6: #333; --background-7: #f2f2f2; --background-8: #ccc; --background-9: transparent; --background-10: #005c86; --background-11: #e1f4fd; --primary-text-color: #1f97f9; --secondary-text-color: #000;}')
	//Setup widget JS
...
var main = function() {
	...
	if(GM_getValue('settings-Stylesheet', false) == 'darkmode') {
		$('<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/PurpleHatHacker/Magister-CSS-update@main/style2.css">').appendTo('head');
	};
